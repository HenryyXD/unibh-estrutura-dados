...
public class TestaContato {
    public static void main(String[] args) {
        ...
        Contato c1 = new Contato("Pratica.Contato 3","3333-3333","contato3@email.com");
		Contato c2 = new Contato("Pratica.Contato 2","2222-2222","contato2@email.com");
		Contato c3 = new Contato("Pratica.Contato 1","1111-1111","contato1@email.com");
        ...
        System.out.println("Verificar se existe Pratica.Contato 3");
        System.out.println("Posicão: " + vetor.busca(c1));

        System.out.println("Verificar se existe Pratica.Contato B");
        System.out.println("Posicão: " + vetor.busca(cB));

        System.out.println("Adicionar contato 2.5 na posição 2");
        Contato c25 = new Contato("Pratica.Contato 2.5","2222-5555","contato25@email.com");
        vetor.adiciona(2,c25);
        System.out.println("Capacidade: " + vetor.capacidade());
        System.out.println(vetor);
        System.out.println("Adicionar contato 1.5 na posição 1");
        Contato c15 = new Contato("Pratica.Contato 1.5","1111-5555","contato15@email.com");
